<?php
/**
* Gutenbiz Dark: Excerpt
*
* @since Darkbiz 1.0.0
*/
if( ! class_exists( 'Gutenbiz_Dark_Excerpt' ) ):

class Gutenbiz_Dark_Excerpt{
...
/**
* Call to Gutenbiz_Dark_Excerpt
*
* @since  1.0.0
* @uses   Gutenbiz_Dark_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'gutenbiz_dark_excerpt' ) ):

    function gutenbiz_dark_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        $length = apply_filters( 'gutenbiz_dark_excerpt_length', $length );
        return Gutenbiz_Dark_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;